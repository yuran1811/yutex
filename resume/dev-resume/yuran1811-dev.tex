...
Results-driven Software Engineer with 3+ years of experience developing scalable web applications and open-source tools. Proven ability to deliver production-ready solutions with high usability and cost efficiency, optimize performance (96+ Lighthouse scores, good SEO ranking for branded queries), and automate CI/CD pipelines to reduce deployment time and enhance reliability.
\end{flushleft}
...
\begin{itemize}[leftmargin=*]\small
	...
	\item \textbf{Tools:} Jira, Figma, Adobe Illustrator.\vspace{-5pt}
